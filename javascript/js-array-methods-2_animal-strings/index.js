...
// OR? animalStrings.findIndex(animal) => animal.includes('giraffe'))
...
const sumOfAllAnimalCharacters = animalStrings.reduce((prev, current) => { return prev + current;
}).length;
