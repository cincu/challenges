...
//    Call "handleUserLogin" and pass your callback function as the first 
//    argument.
//    (You should see the log from your callback message)
// 2. Call "handleUserLogin" again but this time write the callback function 
// as an anonymous function **inside** the function call (i.e. between
//    the round brackets).
//    (You should see the log from your callback message)
